...
class SSASideMenu: UIViewController, UIGestureRecognizerDelegate {
    ...
    struct ContentViewEffect {
        ...
        init(alpha: Float = 1.0, scale: Float = 1.0, landscapeOffsetX: Float = 30, portraitOffsetX: Float = 30, minParallaxContentRelativeValue: Float = -25.0, maxParallaxContentRelativeValue: Float = 25.0, interactivePopGestureRecognizerEnabled: Bool = true) {
    ...
    struct SideMenuOptions {
        ...
        var menuViewControllerTransformation: CGAffineTransform = CGAffineTransform.init(scaleX: 1, y: 1)
        var backgroundTransformation: CGAffineTransform = CGAffineTransform.init(scaleX: 1, y: 1)
        var endAllEditing: Bool = false
        
        init(animationDuration: Float = 0.25, panGestureEnabled: Bool = true, panDirection: SSASideMenuPanDirection = .edge, type: SSASideMenuType = .scale, panMinimumOpenThreshold: UInt = 60, menuViewControllerTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1, y: 1), backgroundTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1, y: 1), endAllEditing: Bool = false) {
    ...
    @IBInspectable var contentViewScaleValue: Float = 1.0
    ...
    @IBInspectable var menuViewControllerTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1, y:1)
    @IBInspectable var backgroundTransformation: CGAffineTransform = CGAffineTransform(scaleX: 1, y:1)
